...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableColumn<Department, Department> tableColumnnEDIT;
	@FXML
	private TableColumn<Department, Department> tableColumnnREMOVE;
	@FXML
	...
	private void initEditButtons() {
		...
		tableColumnnEDIT.setCellFactory(param -> new TableCell<Department, Department>() {
	...
	private void initRemoveButtons() {
		...
		tableColumnnREMOVE.setCellFactory(param -> new TableCell<Department, Department>() {
